...
- Ensure that all CLI commands, such as package installation or build commands, are highlighted using shell backticks for inline commands or fenced `bash` code blocks. This makes command examples stand out and easily copyable.
