...
describe("inlineExtensionsMjs", () => {
  describe("not changed", () => {
    describe("from file", () => {
      test.each(exts)("reexport all: ${ext}", ({ ext }) => {
        ...
        expect(inlineExtensionsMjs(ts, content, fileExists).output).toBe(
          content,
        );
      });
  ...
  describe("changed", () => {
    test("reexport all without extension", () => {
      ...
      expect(inlineExtensionsMjs(ts, input, fileExists).output).toBe(expected);
    });
  ...
  describe("changed + index", () => {
    test("reexport all without extension", () => {
      ...
      expect(inlineExtensionsMjs(ts, input, fileIndexExists).output).toBe(
        expected,
      );
    });
...
describe("inlineExtensionsCjs", () => {
  describe("not changed", () => {
    describe("from file", () => {
      test.each(exts)("reexport all: ${ext}", ({ ext }) => {
        const content = `export * from "./resolveDirs${ext}";\n`;
        expect(inlineExtensionsCjs(ts, content, fileExists).output).toBe(
          content,
        );
      });
  ...
  describe("changed", () => {
    test("reexport all without extension", () => {
      ...
      expect(inlineExtensionsCjs(ts, input, fileExists).output).toBe(expected);
    });
  ...
  describe("changed + index", () => {
    ...
    test("reexport named without extension", () => {
      ...
      expect(inlineExtensionsCjs(ts, input, fileIndexExists).output).toBe(
        expected,
      );
    });
